            ...
            <div class="col-xl-12">
              <ul class="progtrckr" data-progtrckr-steps="4">
                ...
                @if ($order->order_status == 'canceled')
                  <li class="icon-four red_mark">Order Canceled</li>
                @else
                  <li
              ...
              ">
                    order Processing</li>
                  <li class="icon_three 
              @if ($order->order_status == 'out_for_delivery' || $order->order_status == 'delivered') check_mark @endif">on the way
                  </li>
                  <li class="icon_four @if ($order->order_status == 'delivered') check_mark @endif">delivered</li>
                @endif
              </ul>
            </div>
            <div class="col-xl-12">

          ...
          <div class="wsus__pro_det_description">
            <div class="wsus__details_bg">
              <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-profile-tab7"
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-contact-tab23"
                    data-bs-toggle="pill" data-bs-target="#pills-contact23"
                    type="button" role="tab"
                    aria-controls="pills-contact23"
                    aria-selected="false">comment</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-contact-tab239"
                    data-bs-toggle="pill" data-bs-target="#pills-contact239"
                    type="button" role="tab"
                    aria-controls="pills-contact239"
              ...
              <div class="tab-content" id="pills-tabContent4">
                    ...
                    <div class="col-xl-12">
                      <div class="wsus__description_area">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing
                          elit. Voluptatum
                          sapiente aliquam ut neque voluptatibus inventore odit
                          nesciunt.
                          Nobis quas saepe repellat repudiandae qui sint? Delectus
                          dignissimos
                          maiores fuga doloremque magni, ratione provident
                          exercitationem
                          aliquam tempore velit facere autem magnam, architecto
                          inventore
                          recusandae dolorum, illo sequi officiis dolore! Unde
                          enim,
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing
                          ...
                          exercitationem. Lorem ipsum</p>
                        <ul>
                          <li>Consectetur adipisicing elit. Voluptatum sapiente
                            aliquam ut
                            neque voluptatibus inventore odit nesciunt. Nobis quas
                            saepe
                            repellat</li>
                          <li>Delectus dignissimos maiores fuga doloremque magni,
                            ratione
                            provident exercitationem aliquam tempore velit facere
                            autem
                            magnam</li>
                          <li>velit facere autem magnam, architecto inventore
                            recusandae
                            dolorum, illo sequi officiis dolore! Unde enim</li>
                          <li>Repudiandae qui sint? Delectus dignissimos maiores
                            fuga
                            doloremque magni, ratione provident exercitationem
                            aliquam
                            tempore velit facere autem</li>
                          <li>Ipsum dolor sit amet, consectetur adipisicing elit.
                            Voluptatum
                            sapiente aliquam ut neque voluptatibus inventore odit
                            nesciunt.
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-4 col-md-4">
                        <div class="description_single">
                          ...
                          <p>We guarantee our products and you could get back all
                            of your
                      ...
                      <div class="col-xl-4 col-md-4">
                        <div class="description_single">
                          ...
                          <p>Get 20%-50% off items over 50$ for a month or over
                            250$ for a
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                        <div class="wsus__pro_det_vendor_text">
                          ...
                          <p><span>Address:</span> Steven Street, El Carjon, CA
                            92020, United
                            States (US)</p>
                          <p><span>Phone:</span> 1234567890</p>
                          <p><span>mail:</span> example@gmail.com</p>
                          <a href="vendor_details.html" class="see_btn">visit
                            store</a>
                        </div>
                      </div>
                      <div class="col-xl-12">
                        <div class="wsus__vendor_details">
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing
                            ...
                            tincidunt
                            vitae
                            semper quis lectus. Vestibulum mattis ullamcorper
                            velit sed. A
                            arcu
                            cursus vitae congue mauris.
                            <span>A arcu cursus vitae congue mauris. Sagittis id
                              consectetur
                              purus ut. Tellus rutrum tellus pellentesque eu
                              tincidunt
                              tortor
                              aliquam nulla. Diam in arcu cursus euismod quis.
                              Eget sit
                              amet
                              tellus cras adipiscing enim eu. In fermentum et
                              sollicitudin
                              ac
                              orci phasellus. A condimentum vitae sapien
                              pellentesque
                              habitant
                            ...
                            <div class="wsus__main_comment">
                              ...
                              <div class="wsus__comment_text reply">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur
                                  adipisicing
                                  elit.
                                  Cupiditate sint molestiae eos? Officia, fuga
                                  eaque.
                                </p>
                                <ul class="">
                    ...
                    <div class="row">
                      <div class="col-xl-7 col-lg-6">
                        <div class="wsus__comment_area">
                          ...
                          <div class="wsus__main_comment">
                            <div class="wsus__comment_img">
                              <img src="images/dashboard_user.jpg"
                                alt="user" class="img-fluid w-100">
                            </div>
                            <div class="wsus__comment_text reply">
                ...
                <div class="tab-pane fade" id="pills-contact239"
                  role="tabpanel" aria-labelledby="pills-contact-tab239">
                  <div class="row">
                    <div class="col-12">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div id="collapseOne"
                              ...
                              <div class="accordion-body">
                                <p>Lorem ipsum dolor sit amet consectetur
                                  adipisicing
                                  elit.
                                  Voluptatum voluptas ea hic excepturi sit,
                                  sapiente
                                  optio
                                  deleniti pariatur. Dolorum in quos magni?
                                  Necessitatibus
                                  recusandae cupiditate iste expedita amet
                                  voluptatem
                                  laudantium.</p>
                              </div>
                            </div>
                          ...
                          <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThreet1">
                              <button class="accordion-button collapsed"
                                type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseThreet1"
                                aria-expanded="false"
                                aria-controls="collapseThreet1">
                                How can I track an order?
                              </button>
                            </h2>
                            <div id="collapseThreet1"
                              class="accordion-collapse collapse"

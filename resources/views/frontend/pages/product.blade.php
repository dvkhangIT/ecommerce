          ...
          <div class="wsus__pro_page_bammer">
            @if ($productpage_banner_section->banner_one->status == 1)
              <a href="{{ $productpage_banner_section->banner_one->banner_url }}">
                <img class="img-fluid w-100" src="{{ asset($productpage_banner_section->banner_one->banner_image) }}"
                  alt="">
              </a>
            @endif
          </div>
                  ...
                  <div class="accordion-body">
                    <ul>
                      @foreach ($brands as $brand)
                        <li><a href="{{ route('products.index', ['brand' => $brand->slug]) }}">{{ $brand->name }}</a>
                        </li>
                      @endforeach
                    </ul>
                  </div>
              ...
              <div class="wsus__product_topbar">
                <div class="wsus__product_topbar_left">
                  <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button
                      class="nav-link {{ session()->has('product_list_style') && session()->get('product_list_style') == 'grid' ? 'show active' : '' }} {{ !session()->has('product_list_style') ? 'active' : '' }} list-view"
                        ...
                        <div class="wsus__product_details">
                          ...
                          <p class="wsus__pro_rating">
                            @for ($i = 1; $i <= 5; $i++)
                              ...
                              @endif
                            @endfor
                            <span>({{ $product->ratings_avg_review }} review)</span>
                          </p>

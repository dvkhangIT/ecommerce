            ...
            <ul class="wsus__icon_area">
              <li>
                <a href="{{ route('user.wishlist.index') }}">
                  ...
                  <span
                    id="wishlist_count">{{ isset(auth()->user()->id) ? \App\Models\Wishlist::where('user_id', auth()->user()->id)->count() : 0 }}</span>
                </a>
              </li>
        ...
        @foreach (Cart::content() as $sidebarProduct)
          <li id="mini_cart_{{ $sidebarProduct->rowId }}">
            <div class="wsus__cart_img">
              ...
              <a href="#" class="wsis__del_icon remove_sidebar_product" data-id="{{ $sidebarProduct->rowId }}"><i

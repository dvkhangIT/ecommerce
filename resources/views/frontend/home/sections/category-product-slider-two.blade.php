            ...
            <div class="wsus__product_item">
              ...
              <ul class="wsus__single_pro_icon">
                <li><a href="#" data-bs-toggle="modal"
                    data-bs-target="#slider-product-section-two-{{ $product->id }}"><i class="far fa-eye"></i></a>
                </li>
  ...
  @foreach ($products as $product)
    <section class="product_popup_modal">
      <div class="modal fade" id="slider-product-section-two-{{ $product->id }}" tabindex="-1" aria-hidden="true">

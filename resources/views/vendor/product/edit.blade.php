              ...
              <div class="wsus__dash_pro_area">
                <form method="POST" action="{{ route('vendor.products.update', $product->id) }}"
                  ...
                  <div class="form-group wsus__input">
                    <label>Preview</label>
                    <img style="display: block" width="200px" src="{{ asset($product->thumb_image) }}" alt="">
                  </div>
                  <div class="form-group wsus__input">
                    <label>Image</label>
                  ...
                  <div class="form-group wsus__input">
                    ...
                    <textarea class="form-control summernote" name="short_description" id="">{!! $product->short_description !!}</textarea>
                  </div>
                  <div class="form-group wsus__input">
                  ...
                  <div class="form-group wsus__input">
                    ...
                    <textarea class="form-control" name="seo_description" name="" id="">{!! $product->seo_description !!}</textarea>
                  </div>
                  <div class="form-group wsus__input">

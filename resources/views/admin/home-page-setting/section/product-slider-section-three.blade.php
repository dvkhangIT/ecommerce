                ...
                <div class="form-group">
                  ...
                  <select name="cat_one" class="form-control main-category">
                    ...
                    @foreach ($categories as $category)
                      <option {{ $sliderSectionThree[0]['category'] == $category->id ? 'selected' : '' }}
                ...
                <div class="form-group">
                  ...
                  <select name="sub_cat_one" class="form-control sub-category">
                    ...
                    @foreach ($subCategories as $subCategory)
                      <option {{ $sliderSectionThree[0]['sub_category'] == $subCategory->id ? 'selected' : '' }}
                ...
                <div class="form-group">
                  ...
                  <select name="child_cat_one" class="form-control child-category">
                    ...
                    @foreach ($childCategories as $childCategory)
                      <option {{ $sliderSectionThree[0]['child_category'] == $childCategory->id ? 'selected' : '' }}
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="cat_two" class="form-control main-category">
                    <option value="">Select</option>
                    @foreach ($categories as $category)
                      <option {{ $sliderSectionThree[1]['category'] == $category->id ? 'selected' : '' }}
                        value="{{ $category->id }}">{{ $category->name }}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="sub_cat_two" class="form-control sub-category">
                    <option value="">Select</option>
                    @foreach ($subCategories as $subCategory)
                      <option {{ $sliderSectionThree[1]['sub_category'] == $subCategory->id ? 'selected' : '' }}
                        value="{{ $subCategory->id }}">{{ $subCategory->name }}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="child_cat_two" class="form-control child-category">
                    <option value="">Select</option>
                    @foreach ($childCategories as $childCategory)
                      <option {{ $sliderSectionThree[1]['child_category'] == $childCategory->id ? 'selected' : '' }}
                        value="{{ $childCategory->id }}">{{ $childCategory->name }}</option>
                    @endforeach
                  </select>
                </div>

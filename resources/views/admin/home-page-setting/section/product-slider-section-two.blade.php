                ...
                <div class="form-group">
                  ...
                  <select name="cat_two" class="form-control main-category">
                    ...
                    @foreach ($categories as $category)
                      <option {{ $sliderSectionTwo->category == $category->id ? 'selected' : '' }}
                ...
                <div class="form-group">
                  ...
                  <select name="sub_cat_two" class="form-control sub-category">
                    ...
                    @foreach ($subCategories as $subCategory)
                      <option {{ $sliderSectionTwo->sub_category == $subCategory->id ? 'selected' : '' }}
                ...
                <div class="form-group">
                  ...
                  <select name="child_cat_two" class="form-control child-category">
                    ...
                    @foreach ($childCategories as $childCategory)
                      <option {{ $sliderSectionTwo->child_category == $childCategory->id ? 'selected' : '' }}

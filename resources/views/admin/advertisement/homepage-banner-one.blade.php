       ...
       <form action="{{ route('admin.homepage-banner-section-one') }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
           ...
           <label class="custom-switch mt-2">
             <input type="checkbox" {{ $homepage_section_banner_one->banner_one->status == 1 ? 'checked' : '' }}
         ...
         <div class="form-group">
           ...
           <input type="text" value="{{ $homepage_section_banner_one->banner_one->banner_url }}" class="form-control"
             name="banner_url">
         </div>

 <div class="tab-pane fade" id="list-cart" role="tabpanel" aria-labelledby="list-cart-list">
    ...
    <div class="card-body">
      <form action="{{ route('admin.cartpage-banner') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <img src="{{ asset(@$cartpage_banner_section->banner_one->banner_image) }}" width="150px" alt="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" value="{{ @$cartpage_banner_section->banner_one->banner_url }}" class="form-control"
            name="banner_one_url">
        </div>
        <h1>Banner Two</h1>
        <div class="form-group">
        ...
        <div class="form-group">
          <img src="{{ asset(@$cartpage_banner_section->banner_two->banner_image) }}" width="150px" alt="">
        </div>
        <div class="form-group">
          <label>Banner Image</label>
        ...
        <div class="form-group">
          <label>Banner Url</label>
          <input type="text" value="{{ @$cartpage_banner_section->banner_two->banner_url }}" class="form-control"
            name="banner_two_url">
        </div>

  ...
  <div class="card border">
    <div class="card-body">
      <form action="{{ route('admin.homepage-banner-section-two') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <img src="{{ asset(@$homepage_section_banner_two->banner_one->banner_image) }}" width="150px" alt="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="control-label">Status</div>
          <label class="custom-switch mt-2">
            <input type="checkbox" {{ @$homepage_section_banner_two->banner_two->status == 1 ? 'checked' : '' }}
              name="banner_two_status" class="custom-switch-input">
            <span class="custom-switch-indicator"></span>
          </label>
        </div>
        <div class="form-group">
          <img src="{{ asset(@$homepage_section_banner_two->banner_two->banner_image) }}" width="150px" alt="">
        </div>
        <div class="form-group">
          <label>Banner Image</label>
        ...
        <div class="form-group">
          <label>Banner Url</label>
          <input type="text" value="{{ @$homepage_section_banner_two->banner_two->banner_url }}" class="form-control"
            name="banner_two_url">
        </div>

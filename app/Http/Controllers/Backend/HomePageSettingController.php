...
class HomePageSettingController extends Controller
{
    ...
    public function updatePopularCategorySection(Request $request)
    {
        $request->validate(
            ...
            [
                'cat_one' => 'Category one filed is required',
                'cat_two' => 'Category one filed is required',
                'cat_three' => 'Category three filed is required',
                'cat_four' => 'Category four filed is required',
            ]
        );
        $data = [
            [
    ...
    {
        $request->validate(['cat_one' => ['required']], ['cat_one' => 'Category filed is required']);
        $data = [
            'category' => $request->cat_one,
            'sub_category' => $request->sub_cat_one,
            'child_category' => $request->child_cat_one,
    ...
    {
        $request->validate(['cat_two' => ['required']], ['cat_two' => 'Category filed is required']);
        $data = [
            'category' => $request->cat_two,
            'sub_category' => $request->sub_cat_two,
            'child_category' => $request->child_cat_two,
    ...
    public function updateProductSliderSectionThree(Request $request)
    {
        $request->validate(
            ...
            [
                'cat_two' => 'Part 2 Category filed is required',
                'cat_one' => 'Part 1 Category filed is required',
            ]
        );
        $data = [
            [

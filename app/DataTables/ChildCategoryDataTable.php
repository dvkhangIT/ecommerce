  ...
  public function dataTable(QueryBuilder $query): EloquentDataTable
  {
    return (new EloquentDataTable($query))
      ...
      ->addColumn('action', function ($query) {
        ...
        $deleteBtn = '<a href="' . route('admin.child-category.destroy', $query->id) . '" class="btn btn-danger ml-1 delete-item"><i class="far fa-trash-alt"></i></a>';
      ...
      ->rawColumns(['category', 'sub_categories', 'action', 'status'])
      ->setRowId('id');
  }
